...
Using this work, Kartik et al.\ provided a framework that uses synthetic data generation with joint learning that improves translation quality for noisy, code-mixed text. Their method generated large code-mixed data~\citep{kartik2024}. It also uses joint training to share parameters around clean and noisy examples, which means that it gave an improved performance even in zero-shot transfer to new code-mixed variants.
...
We had the following approach for tokenizing the data - mBERT tokenizer. The BERT tokenizer uses BPE (byte-pair encoding) subword tokenization. We used the BertTokenizer from HuggingFace transformers [5]. OOV words are handled using subwords. This particular tokenizer had been pretrained on $104$ languages. We limited our max sequence length to $128$ - anything longer was truncated. [4]
...
\begin{enumerate}[label = {[\arabic*]}]
    \item kartik, "HINMIX\_hi-en," Hugging Face, Feb. 2025, doi: https://doi.org/10.57967/hf/4520.
